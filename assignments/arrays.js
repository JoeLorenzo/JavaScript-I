...
console.log(`Car 33 is a ${(inventory[0].car_year)} ${(inventory[0].car_make)} ${(inventory[0].car_model)}` );



// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
let lastCar = `The last car is a ${(inventory[(inventory.length-1)].car_make)} ${(inventory[(inventory.length-1)].car_model)}`
console.log(lastCar);
